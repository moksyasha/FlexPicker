...
# Add print_spooler_circular file to system dump
sysdmp_add -name PRINT_SPOOLER_CIRCULAR -source print_spooler_circular -save print_spooler_save_circular_log -fileext log
...
# Generate sysdump on "No data for UDPUC device"
sysdmp_trigger_add -name ELOG_41822 -elog_domain 4 -elog_number 1822
# Generate sysdump on "Interupt queue full"
sysdmp_trigger_add -name ELOG_40206 -elog_domain 4 -elog_number 206
# Generate sysdump on "Overspeed during teach mode"
...
# Add no of used motion objects system dump service
sysdmp_add -name IPOLNOMOTIONOBJ -show ipol_print_no_of_used_motion_objects
